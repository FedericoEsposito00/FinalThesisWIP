...
COMPILER_COMMAND_FILE     = Estimator_comp.rsp
CMD_FILE                  = Estimator.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Estimator.exe
...
DEFINES_STANDARD = -DMODEL=Estimator -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\Estimator_ert_rtw\Estimator.cpp $(START_DIR)\Estimator_ert_rtw\Estimator_data.cpp

MAIN_SRC = $(START_DIR)\Estimator_ert_rtw\ert_main.cpp
...
OBJS = Estimator.obj Estimator_data.obj
...
{$(START_DIR)\Estimator_ert_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Estimator_ert_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Estimator.obj : "$(START_DIR)\Estimator_ert_rtw\Estimator.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\Estimator_ert_rtw\Estimator.cpp"


Estimator_data.obj : "$(START_DIR)\Estimator_ert_rtw\Estimator_data.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\Estimator_ert_rtw\Estimator_data.cpp"


ert_main.obj : "$(START_DIR)\Estimator_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\Estimator_ert_rtw\ert_main.cpp"
