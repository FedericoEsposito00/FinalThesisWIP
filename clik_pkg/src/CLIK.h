...
//
//  hilite_system('SetBasedTasks_CLIK_pinv_sendtoros/CLIK')    - opens subsystem SetBasedTasks_CLIK_pinv_sendtoros/CLIK
//  hilite_system('SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Kp') - opens and selects block Kp
//
//  Here is the system hierarchy for this model
//
//  '<Root>' : 'SetBasedTasks_CLIK_pinv_sendtoros'
//  '<S1>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK'
//  '<S2>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)'
//  '<S3>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)1'
//  '<S4>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/dirkin_l'
//  '<S5>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/dirkin_r'
//  '<S6>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/q_l_dot'
//  '<S7>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/q_r_dot'
//  '<S8>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)/Enable//disable time constant'
//  '<S9>'   : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)/Initialization'
//  '<S10>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)/Integrator (Discrete or Continuous)'
//  '<S11>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)/Initialization/Init_u'
//  '<S12>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)/Integrator (Discrete or Continuous)/Discrete'
//  '<S13>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)1/Enable//disable time constant'
//  '<S14>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)1/Initialization'
//  '<S15>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)1/Integrator (Discrete or Continuous)'
//  '<S16>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)1/Initialization/Init_u'
//  '<S17>'  : 'SetBasedTasks_CLIK_pinv_sendtoros/CLIK/Filtered Derivative (Discrete or Continuous)1/Integrator (Discrete or Continuous)/Discrete'
